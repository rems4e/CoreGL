...
std::ostream &operator<<(std::ostream &s, vec4 const &c) {
    return s << '(' << c.x << ", " << c.y << ", " << c.z << ", " << c.w << ')';
}

std::ostream &operator<<(std::ostream &s, vec3 const &c) {
    return s << '(' << c.x << ", " << c.y << ", " << c.z << ')';
}

std::ostream &operator<<(std::ostream &s, vec2 const &c) {
    return s << '(' << c.x << ", " << c.y << ')';
}

std::ostream &operator<<(std::ostream &s, ivec2 const &c) {
    return s << '(' << c.x << ", " << c.y << ')';
}
